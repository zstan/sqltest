...
if __name__== "__main__":
        ...
        print (run_test("CREATE TABLE TABLE_F051_01_01_011 ( A DATE )"))
        print (run_test("CREATE TABLE TABLE_F041_07_01_061 ( A INTEGER )"))
        print (run_test("SELECT TABLE_F041_07_01_061.A FROM TABLE_F041_07_01_061 JOIN TABLE_F041_07_01_061 AS TABLE_F041_07_01_062 USING ( A ) AS FOO"))

        #print (run_test("CREATE TABLE TABLE_F041_07_01_021 ( A INTEGER PRIMARY KEY, CC INTEGER  )"))
        #print (run_test("SELECT TABLE_F041_07_01_021.A FROM TABLE_F041_07_01_021 INNER JOIN TABLE_F041_07_01_021 AS
        #TABLE_F041_07_01_022 USING ( A )"))
        ...
        #print (run_test("SELECT TABLE_F041_04_01_061.A, TABLE_F041_04_01_062.A FROM TABLE_F041_04_01_061 RIGHT OUTER
        # JOIN TABLE_F041_04_01_062 USING ( A ) AS FOO"))
        #print (run_test(""))
        #print (run_test(""))
        #print (run_test(""))
        #print (run_test(""))
